...
Maps workspace directory names to confirm this config applies. If the current workspace is not listed, the skill will prompt to create project-level settings.
